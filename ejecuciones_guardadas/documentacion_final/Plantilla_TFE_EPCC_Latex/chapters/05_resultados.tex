...
Al evaluar los algoritmos evolutivos de forma aislada (Figura~\ref{fig:dunn_hv_prop_alg}), el test estadístico permite estructurar el rendimiento en niveles de significancia diferenciados. El primer grupo estadístico está liderado por AGE-MOEA-II, el cual se halla emparejado estadísticamente con NSGA-II.

El segundo grupo estadístico engloba a los MaOEA (U-NSGA-III y NSGA-III) conjuntamente con SPEA2. Como se ha documentado previamente, los algoritmos basados en vectores de referencia sobre una topología discreta obliga a que parte de los recursos de búsqueda se desvíen hacia regiones infactibles, reduciendo la cardinalidad del frente poblacional resultante~\cite{deb2013evolutionary, ishibuchi2015behavior}. SPEA2, a pesar de operar con mecanismos menos especializados para problemas MaO ()TODO poner lo kNN (Duda, no śe si ya se ha usado este acronimo, la primera vez que se use hay que ponerlo entre aprentessis junto a us nombre completo), iguala el rendimiento de este grupo.

En un estrato inferior se ubica SMS-EMOA junto con SPEA2, que actúa como puente estadístico. El escaso rendimiento de SMS-EMOE con respecto otros algoritmos se explicó en el experimento anterior.
...
La principal diferencia con respecto al experimento absoluto es que NSGA-II ha pasado de ser el algoritmo con mejor rendimiento a compartir el primer puesto con AGE-MOEA-II, demostrando que los cambios realizados en las funciones objetivos alteran los resultados.
