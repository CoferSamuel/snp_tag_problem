...
\begin{itemize}
    \item Evaluar el impacto que supone modelar las funciones objetivo del problema de diferentes modos: en un caso utilizando cuatro objetivos independientes y en el otro también dichos objetivos, pero dividiendo dos de ellos por el número de etiquetas SNP \cite{ting2010multi, moqa2022assessing}.
